...
export declare const messages: {
    ...
    force_source_legacy_pull_default_scratch_org_text: string;
    force_source_legacy_pull_force_default_scratch_org_text: string;
    force_source_push_default_scratch_org_text: string;
    force_source_push_force_default_scratch_org_text: string;
    force_source_legacy_push_default_scratch_org_text: string;
    force_source_legacy_push_force_default_scratch_org_text: string;
    force_source_status_text: string;
    force_source_legacy_status_text: string;
    ...
    force_function_container_start_text: string;
