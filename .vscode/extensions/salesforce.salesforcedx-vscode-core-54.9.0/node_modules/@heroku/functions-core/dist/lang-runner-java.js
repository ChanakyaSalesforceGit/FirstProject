...
const runtimeJarSha = '87d1031ae0250b58da46028271f446b1e20cc04412cebdf8b45e6468fd28ae4f';
class LangRunnerJava extends lang_runner_1.default {
    ...
    downloadRuntimeJar() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.ensureDirExists(runtimeJarDir);
                yield this.downloadToFile(runtimeJarUrl, runtimeJarPath);
                yield this.verifyFileSha(runtimeJarPath, runtimeJarSha);
            }
            catch (err) {
                try {
    ...
    runRuntimeJarServe() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield execa.command(`java ${agentLibArg} -jar ${runtimeJarPath} serve --host=${this.host} --port=${this.port} ${this.path}`, {
                cwd: this.path,
                stdio: 'inherit',
            });
        });
    ...
    verifyFileSha(path, expectedDigest) {
        return __awaiter(this, void 0, void 0, function* () {
