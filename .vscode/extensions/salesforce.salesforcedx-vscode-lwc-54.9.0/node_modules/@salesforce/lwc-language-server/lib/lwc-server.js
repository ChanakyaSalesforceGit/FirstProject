...
class Server {
    constructor() {
        this.connection = vscode_languageserver_1.createConnection();
    ...
    async onInitialize(params) {
        ...
        this.languageService = vscode_html_languageservice_1.getLanguageService({
    ...
    async onDidSave(change) {
        ...
        const { uri } = document;
        if (await this.context.isLWCJavascript(document)) {
            const doc = await compiler_1.compileDocument(document);
    ...
    onDefinition(params) {
        ...
        switch (cursorInfo.type) {
            case Token.Tag:
                return ((_a = tag) === null || _a === void 0 ? void 0 : _a.allLocations) || [];
            case Token.AttributeKey:
                const attr = (_b = tag) === null || _b === void 0 ? void 0 : _b.attribute(cursorInfo.name);
                if (attr) {
            ...
            case Token.DynamicAttributeValue:
                ...
                if (cursorInfo.range) {
                    ...
                    const location = (_c = component) === null || _c === void 0 ? void 0 : _c.classMemberLocation(cursorInfo.name);
                    if (location) {
                        return [location];
                    }
                }
            ...
            case vscode_html_languageservice_1.TokenType.AttributeValue: {
                ...
                if (match) {
                    ...
                    return {
                        ...
                        range: (_a = item) === null || _a === void 0 ? void 0 : _a.range,
                        tag,
                    };
                }
                else {
            ...
            case vscode_html_languageservice_1.TokenType.Content: {
                ...
                if (match) {
                    ...
                    return {
                        ...
                        name: match,
                        range: (_b = item) === null || _b === void 0 ? void 0 : _b.range,
                        tag,
                    };
                }
                else {
    ...
    listen() {
        lightning_lsp_common_1.interceptConsoleLogger(this.connection);
